...
haxelib --always --quiet git troll-ui https://github.com/troll-slaiyers/Troll-UI 7a96093017a0964ddd3c0cd8d6a5c9d6b70b41e6
...
haxelib --always --quiet  --skip-dependencies install hxvlc 2.3.0
