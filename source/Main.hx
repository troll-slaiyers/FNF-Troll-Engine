...
class Main extends Sprite
{
	...
	var nextState:Class<FlxState> = funkin.states.options.OptionsState; // The FlxState the game will go to after the InitState. This is usually set to PlayState, but you can change it to whatever you want.
